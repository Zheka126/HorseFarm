...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 12 2020 г., 13:11
...
(6, 4, 'Homo sapiens', 'allucaddig6853@suckmail.com', '+373-985-66-681'),
...
(3, 4, 'Консервированная конина и подделки из костей', 'bonesandguts@mail.com', '+373-414-80-809'),
...
(2, 'Вегас', 400, 1.4, 66, 4),
(3, 'Мустанг', 1200, 2, 50, 15),
(4, 'Валент', 521, 1.63, 63, 6),
(5, 'Вольт', 450, 1.5, 80, 7),
(6, 'Оствинд', 980, 1.75, 64, 11),
(7, 'Гром', 733, 1.7, 73, 9),
...
(7, 3, 'По городу буду кататься', 'addyloppuco2166@yopmail.com', '+373-987-57-582'),
...
--
ALTER TABLE `crossbreeding`
  MODIFY `ID customer` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `farms`
  MODIFY `ID farm` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT для таблицы `horses`
--
ALTER TABLE `horses`
  MODIFY `ID horse` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- Ограничения внешнего ключа таблицы `crossbreeding`
--
ALTER TABLE `crossbreeding`
  ADD CONSTRAINT `crossbreeding_ibfk_1` FOREIGN KEY (`ID horse`) REFERENCES `horses` (`ID horse`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Ограничения внешнего ключа таблицы `education`
--
ALTER TABLE `education`
  ADD CONSTRAINT `education_ibfk_1` FOREIGN KEY (`ID horse`) REFERENCES `horses` (`ID horse`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Ограничения внешнего ключа таблицы `farms`
--
ALTER TABLE `farms`
  ADD CONSTRAINT `farms_ibfk_1` FOREIGN KEY (`ID horse`) REFERENCES `horses` (`ID horse`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Ограничения внешнего ключа таблицы `races`
--
ALTER TABLE `races`
  ADD CONSTRAINT `races_ibfk_1` FOREIGN KEY (`ID horse`) REFERENCES `horses` (`ID horse`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
